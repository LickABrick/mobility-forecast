...
Accepted decisions for the phase-1 architecture:

1. [ADR 0001 — Build a clean-room HACS-first integration](0001-clean-room-hacs-first.md)
2. [ADR 0002 — Represent one forecast profile per config entry](0002-one-config-entry-per-profile.md)
